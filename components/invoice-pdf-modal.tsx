    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="pdf-modal-card relative w-full max-w-3xl max-h-[90vh] bg-white rounded-[2.5rem] p-6 sm:p-10 text-gray-900 shadow-2xl cursor-default my-auto overflow-y-auto scrollbar-none"
